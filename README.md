<div align="center">
  ...
  <h3 align="center">AuraView | AI-powered Architectural Visualization App</h3>
...
- **[CodeRabbit](https://coderabbit.ai)** is an AI-powered code review platform that provides deep insights and automated suggestions to improve code quality and security.
...
```bash
git clone https://github.com/itzzSVR-tech/AuraView
cd AuraView
```
